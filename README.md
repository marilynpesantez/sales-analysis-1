...
* **The loss of the high-performing Road-150 model was a key driver of the 2012 revenue decline in the Road Bike subcategory.** This model generated $5,524,432 in 2011 (78.08% of total revenue that year) and held the top spot for Road Bike sales in all 6 markets. It was discontinued in 2012 and replaced by the Road-250 model, which had an overall average selling price of $2,279.14 but failed to generate comparable demand. This model brought in only $2,719,010 in 2012, less than half that of the Road-150. This switch had the greatest negative in the U.S. and Australia, where it had previously contributed considerably to overall revenue. 
