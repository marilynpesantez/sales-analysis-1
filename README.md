# Project Background
This project explores sales, customer, and product-level data from an anonymous retailer, with available records spanning from December 29th, 2010, to January 28th, 2014. Although the original data source is unspecified, the dataset provides a multi-year view of retail activity, making it well-suited for exploratory analysis. This project analyzes overall retail performance to uncover actionable insights into sales trends and product performance. The goal is to inform long-term product strategy and uncover opportunities for targeted regional promotions, particularly around seasonal fluctuations and holiday-driven demand.


Insights and recommendations are provided on the following key areas:

- **Sales Trend Analysis:** An evaluation of monthly and seasonal sales performance, focusing on key metrics such as Sales Revenue, Order Volume, Average Order Value (AOV), and YoY growth. These insights help uncover demand cycles and inform more effective promotion timing.
...
- **Product Performance Evaluation:** An in-depth analysis of high top-performing categories, subcategories, and products to understand their contribution to overall revenue over time. These insights will inform product lifecycle strategy, expansion planning, as well as product bundling or promotional opportunities.

The SQL queries used to inspect and clean the data for this analysis can be found here [].

Targeted SQL queries regarding various business questions can be found here [https://public.tableau.com/views/SalesPerformanceDashboard_17525473635890/Dashboard5?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link].



# Data Structure & Initial Checks

The company's main database structure as seen below consists of three tables: gold_customers, gold_sales, and gold_products with a total row count of 79,177 records.
...
Revenue performance from 2011 to 2013 was shaped by product mix and pricing strategy, which influenced volatility in demand. A poorly timed discontinuation of the top-selling Road Bike model led to considerable revenue decline in 2012, while the 2013 rebound was driven by high-volume Mountain Bike sales and more broadly, the introduction of lower-cost products in the new Accessories and Clothing categories. The stability of future revenue depends on aligning product transitions with purchasing behavior, such as using lower-ticket items to drive customer acquisition and volume. Regional sales cycles should be centered around stimulating demand in high AOV regions like Australia and focus on upselling during periods of high demand.
...
* **Overall sales revenue decreased by $1,232,857 from 2011 to 2012, a 17.4% YoY drop.** While overall order volume improved, average order value fell across all six regions, contributing to a 44.0% decrease in overall AOV. 
 
* **Sales performance rebounded in 2013, with overall sales revenue increasing by $10,507,639, a 179.86% YoY rise from 2012. Order volume also surged, growing by 551.2%.** This steep growth coincided with the launch of two new product categories: Accesories and Clothing. While this further reduced average order value, the product expansion allowed for lower-cost entry points into the retailer's storefront.
...
* **Touring Bikes and broader product expansion fueled strong revenue recovery in 2013.** The company introduced Accesories and Clothing in late 2012, which despite only accounting for 6.1% of revenue in 2013, diversified the product mix and likely supported customer acquisition. These lower-cost items allowed for average selling prices of $19.40 and $37.25 within the Accesories and Clothing categories, respectively, and sold a total of 43,120 units in that first full year. This boost in traffic likely supported the sales of high-value items like bikes. Touring bikes saw strong adoption in the US and Australia, making up 23.4% of sales revenue in 2013.
...
* **Manage product lifecycles based on historical performance and regional considerations.** Before discontinuing a top-performing product, the product team should pilot the successor model in a single region and use A/B testing to test for market fit and validate pricing strategy. This will prevent losses like the one's experienced within the discontinuation of the Road-150 model in 2012. A limited inventory of the legacy model should be kept until the succesor model is tested (at least three months) and gains traction. 

* **Tailor product pricing and marketing strategy based on usage context and buyer behavior**. Mountain bikes typically endure harsher terrain and riding conditions, making it more frequently replaced and sensitive to price. This likely contributed to the success of the lower cost Mountain-200 model. Road bikes are used on smoother surfaces, allowing for a longer lifespan. Not only might customers be willing to invest more in road bike durability, they might actually be susceptible to the price-quality heuristic for this type of bike, making the shift to a lower-cost model potentially damaging to revenue. Thus, user behavior should be considered when setting prices. The product team should consider introducing language or product badges that position  Road bikes as being a premium/luxury items and Mountain Bikes as providing value for money.

* **Use lower-ticket items as a tool for customer acquisition and upselling during high-volume periods.** Accessories and Clothing played a key role in the 2013 revenue recovery by expanding the product mix, attracting more customers and boosting order volume. This new traffic likely supported the lift in sales of higher priced products. The business should continue developing low-cost offerings and implement limited time discounts and bundling offers with high-value items to increase average order value. These campaigns should be concentrated in June-August and October-December, when traffic and order volume levels are already elevated.
  
* **Launch re-engagement email campaigns for low-cost product buyers.** The campaign should target customers who bought Accessories or Clothing in the last 6 months with tailored bundles or discounts that include high-ticket items such as Bikes. The team should use the last logged purchase category and timestamp to send out an automated email with the subject "Upgrade Your Ride". This may be particularly effective in markets with high AOV like Australia.

* **Capitalize on markets with high average order value during.** Leverage targeted campaigns and incentives to increase order frequency in regions where customers are already willing to spend more per transaction. With tailored messaging on bundles and new releases, a loyalty program in high AOV regions might encourage repeat purchases and nudge customers towards higher-value items.Usage regional sales cycles to time discounts and promotions.

* **Use regional sales cycles to optimization promotion calendar**. The marketing team should run summer campaigns in North America in time for seasonal sales spices. 
