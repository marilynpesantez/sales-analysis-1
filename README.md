...
* **Capitalize on markets with high average order value.** Leverage targeted campaigns and incentives to increase order frequency in regions where customers are already willing to spend more per transaction. The marketing team should consider running a targeted email campaign in high AOV markets for customers who purchased accessories or clothing in the past 6 months to get past purchasers back in the store. With tailored messaging on bundles and new releases, a loyalty program would hopefully encourage repeat purchases and may nudge customers towards higher-value items.
